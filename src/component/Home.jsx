import img from '../assets/nishag.jpg';
export const Home = () => {
    return (
        <section className="home w-screen h-screen  flex flex-col items-center justify-center text-center" >
            ...
            <div className="image md:w-64 md:h-64 max-sm:w-48 max-sm:h-48 ">
                <img className="profile-image md:w-64 md:h-[310px] sm:w-60 sm:h-60 max-sm:w-48 max-sm:h-56" src={img} alt="" />
            </div>
            <div className="content-text  font-font-poppins">
                <h2 className=' md:text-4xl sm:text-2xl'>Hi I'm<span className='md:text-5xl max-sm:text-3xl'> NISHANTHINI</span></h2>
